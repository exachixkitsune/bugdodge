...
func set_lives_images() -> void:
	if lives >= 3:
		$UIBox/Life_1.animation = "Live"
		$UIBox/Life_2.animation = "Live"
		$UIBox/Life_3.animation = "Live"
	elif lives == 2:
		$UIBox/Life_1.animation = "Live"
		$UIBox/Life_2.animation = "Live"
		$UIBox/Life_3.animation = "Dead"
	elif lives == 1:
		$UIBox/Life_1.animation = "Live"
		$UIBox/Life_2.animation = "Dead"
		$UIBox/Life_3.animation = "Dead"
	else:
		$UIBox/Life_1.animation = "Dead"
		$UIBox/Life_2.animation = "Dead"
		$UIBox/Life_3.animation = "Dead"
